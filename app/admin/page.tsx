...
import { Anchor, InboxIcon, MapPin, ClipboardList } from 'lucide-react'
import type { Request, LocationWithNeeds } from '@/types/database'
...
export default async function AdminPage() {
  ...
  const [{ data: pendingData }, { data: activeData }, { data: locationsData }] = await Promise.all([
    supabase
      .from('requests')
      .select('*')
      .eq('status', 'pendiente')
